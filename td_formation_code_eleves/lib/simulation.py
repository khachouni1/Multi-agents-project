...
# =============================================================================
    ...
    # -------------------------------------------------------------------------
    def plotXY(self, figNo = 1, xmin=-10, xmax=10, ymin=-10, ymax=10, steps=None, color='b'):
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------       
    def animation(self, figNo=1, xmin=-10, xmax=10, ymin=-10, ymax=10, color='b', robot_scale=0.1, pause=0.0001):
    # -------------------------------------------------------------------------
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    # -----------------------------------------------------------------------------------
    def plotXY(self, figNo=1,  xmin=-10, xmax=10, ymin=-10, ymax=10, steps=None, links=False):
    # -----------------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------       
    def animation(self, figNo=1, xmin=-10, xmax=10, ymin=-10, ymax=10, robot_scale=0.1, pause=0.0001):
    # -------------------------------------------------------------------------
...
# =============================================================================
    ...
    if (test_no==4):    
        ...
        for t in simulation.t:
            ...
            referenceState= np.array([2., 1.])
            for r in range(0, fleet.nbOfRobots):
                u_cart = kp* (referenceState - fleet.robot[r].state[0:2])
